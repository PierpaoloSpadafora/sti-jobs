...
export class JobControllerService {
    ...
    public getAllJobs( observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
      ...
      return this.httpClient.request<JobDTO[]>(
        'get',
        `${this.basePath}/api/v1/job/get-all-jobs/`,
        {
          withCredentials: this.configuration.withCredentials,
          headers: headers,
          observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getJobById( id: number, observe?: 'body', reportProgress?: boolean ): Observable<JobDTO>;
    public getJobById( id: number, observe?: 'response', reportProgress?: boolean ): Observable<HttpResponse<JobDTO>>;
    public getJobById( id: number, observe?: 'events', reportProgress?: boolean ): Observable<HttpEvent<JobDTO>>;
    public getJobById( id: number, observe: any = 'body', reportProgress: boolean = false  ): Observable<any> {
      ...
      return this.httpClient.request<JobDTO>(
        'get',
        `${this.basePath}/api/v1/job/${encodeURIComponent(String(id))}`,
        {
          withCredentials: this.configuration.withCredentials,
          headers: headers,
          observe: observe,
